...
df=pd.read_csv('/Users/benjyb/Documents/GitHub/MDM3-Kooth-2/Data/Wards/Median_Prices.csv',header=0,parse_dates=[0],index_col=0)
df.index = pd.date_range(start=df.index[0], periods=len(df), freq='Q')
df_train = df.iloc[:-30] #splitting into Training and Testing data, last 6 years for testing
df_test = df.iloc[-30:]
